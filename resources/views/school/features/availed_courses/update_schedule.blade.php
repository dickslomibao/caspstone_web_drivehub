...
<div class="container-fluid" style="padding: 20px;margin-top: 60px">
    ...
    <form method="POST" id="form-create"
        action="{{ route('actionupdate.practical', [
            'order_list_id' => $course->id,
        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="mb-3" style="margin-bottom: 0">
                    ...
                    <input type="datetime-local" value="{{ $schedule->start_date }}" name="start_date" value=""
            ...
            <div class="col-6">
                <div class="mb-3" style="margin-bottom: 0">
                    ...
                    <input type="datetime-local" value="{{ $schedule->end_date }}" name="end_date" class="form-control"
                        id="end_date">
                </div>
            </div>
                        ...
                        <div class="mb-3" style="margin-bottom: 0">
                            ...
                            <select class="form-control" name="instructor" id="instructor" required>
                                ...
                                @foreach ($instructors as $instructor)
                                    <option {{ $instructor->user_id == $i ? 'selected' : '' }}
                                        value="{{ $instructor->user_id }}" id="{{ $instructor->user_id }}">
                        ...
                        <div class="mb-3" style="margin-bottom: 0">
                            ...
                            <Select class="form-control" name="vehicle" id="vehicle" required>
                                ...
                                @foreach ($vehicles as $vehicle)
                                    <option {{ $vehicle->id == $v ? 'selected' : '' }} id="{{ $vehicle->id }}"
                                        value="{{ $vehicle->id }}">
