...
} elseif ($status == 0 && $payment !== 0) {
    $title = 'ORDERS & PAYMENT: PAYMENT METHOD - ' . $paymentString;
} elseif ($status !== 0 && $payment == 0) {
    $title = 'ORDERS & PAYMENT: STATUS -' . $statusString;
} elseif ($status !== 0 && $payment !== 0) {
    $title = 'ORDERS & PAYMENT:  STATUS - ' . $statusString . ' AND PAYMENT METHOD -' . $paymentString;
}
