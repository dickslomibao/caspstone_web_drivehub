...
<body>
    ...
    <div class="col-11 mx-auto m-3">
        ...
        <div style="margin-top: 20px;">
            <center>
                <h4><b>TOTAL SALES OF COURSES
                        {{strtoupper(\Carbon\Carbon::parse($currentDate)->format('F j, Y'))}}</b></h4>
        ...
        <table style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <b>{{number_format($totalBalance, 2)}} =</b>
                    </td>
                    <td>
                        <b>{{number_format($sum - $totalBalance, 2)}} </b>
                    </td>
                </tr>
                @else
