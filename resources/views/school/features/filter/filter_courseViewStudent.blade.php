...
<div class="w-100 d-flex justify-content-between table-header-btn">
    <div class="d-flex" style="gap:15px">
        <a class="btn-outline-light" href="/school/reports/course/viewStudents/{{$course_id}}/{{$course_name}}/{{$start_date}}/{{$end_date}}/{{$duration}}/export_pdf"><i class="fa-solid fa-file-export"></i>Export
            PDF</a>
    </div>
